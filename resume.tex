...
\documentclass{inc/res} 
\usepackage{inc/helvetica} % uses helvetica postscript font (download helvetica.sty)
...
\address{\bf 
	...
	\userAddressOneVar{}\\
	\userAddressTwoVar{}\\
	\userAddressCityVar{}, \userAddressStateVar{} \userAddressZipVar{}\\ 
	\userPhoneVar{}}

 
\begin{resume}
% with postscript font \sl produces bold italic
